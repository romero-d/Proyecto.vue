<template>
  ...
  const images = ref([
    { id: 1, pieza: './src/assets/Otoño/11.png' },
    { id: 2, pieza: './src/assets/Otoño/12.png' },
    { id: 3, pieza: './src/assets/Otoño/13.png' },
    { id: 4, pieza: './src/assets/Otoño/21.png' },
    { id: 5, pieza: './src/assets/Otoño/22.png' },
    { id: 6, pieza: './src/assets/Otoño/23.png' },
    { id: 7, pieza: './src/assets/Otoño/31.png' },
    { id: 8, pieza: './src/assets/Otoño/32.png' },
    { id: 9, pieza: './src/assets/Otoño/33.png' },
    { id: 10, pieza: './src/assets/Otoño/41.png' },
    { id: 11, pieza: './src/assets/Otoño/42.png' },
    { id: 12, pieza: './src/assets/Otoño/43.png' },
  ]);
  
  const caja = './src/assets/Otoño/OtoñoR.jpg';
  const draggedItemId = ref(null);
  const imagen='./src/assets/Otoño/Otoño.jpg';
      ...
      if (draggedImage) {
        ...
        if (draggedImage.id === 2 && targetId === 2) {
          ...
          if (dropDiv) {
            ...
            imgElement.src = draggedImage.pieza;
            imgElement.style.position="relative";
            imgElement.style.width="121%";
            imgElement.style.height="108%";
            imgElement.style.top="-4px";
        ...
        if (draggedImage.id === 3 && targetId === 3) {
          ...
          if (dropDiv) {
            ...
            imgElement.src = draggedImage.pieza;
            imgElement.style.position="relative";
            imgElement.style.width="108%";
            imgElement.style.height="124%";
            imgElement.style.top="-4px";
        ...
        if (draggedImage.id === 5 && targetId === 5) {
          ...
          if (dropDiv) {
            ...
            imgElement.src = draggedImage.pieza;
            imgElement.style.position="relative";
            imgElement.style.width="131%";
            imgElement.style.height="136%";
            imgElement.style.top="-29px";
            imgElement.style.right="28px";
            imgElement.draggable = false;
            draggedItemId.value = null;
            dropDiv.innerHTML = "";
            dropDiv.appendChild(imgElement);
        ...
        if (draggedImage.id === 6 && targetId === 6) {
          ...
          if (dropDiv) {
            ...
            imgElement.src = draggedImage.pieza;
            imgElement.style.position="relative";
            imgElement.style.width="106%";
            imgElement.style.height="131%";
            imgElement.style.top="-12px";
            imgElement.style.right="11px";
            imgElement.draggable = false;
            draggedItemId.value = null;
            dropDiv.innerHTML = "";
            dropDiv.appendChild(imgElement);
        ...
        if (draggedImage.id === 7 && targetId === 7) {
          ...
          if (dropDiv) {
            ...
            imgElement.src = draggedImage.pieza;
            imgElement.style.position="relative";
            imgElement.style.width="116%";
            imgElement.style.height="113%";
        ...
        if (draggedImage.id === 8 && targetId === 8) {
          ...
          if (dropDiv) {
            ...
            imgElement.src = draggedImage.pieza;
            imgElement.style.position="relative";
            imgElement.style.width="124%";
            imgElement.style.height="126%";
            imgElement.style.top="-24px";
            imgElement.style.right="10px";
            imgElement.draggable = false;
            draggedItemId.value = null;
            dropDiv.innerHTML = "";
        ...
        if (draggedImage.id === 10 && targetId === 10) {
          ...
          if (dropDiv) {
            ...
            imgElement.style.width="117%";
            imgElement.style.height="123%";
            imgElement.style.left="4px";
            imgElement.draggable = false;
            draggedItemId.value = null;
            dropDiv.innerHTML = "";
        ...
        if (draggedImage.id === 11 && targetId === 11) {
          ...
          if (dropDiv) {
            ...
            imgElement.style.height="120%";
            imgElement.style.right="6px";
            imgElement.draggable = false;
            draggedItemId.value = null;
            dropDiv.innerHTML = "";
            dropDiv.appendChild(imgElement);
        ...
        if (draggedImage.id === 12 && targetId === 12) {
          ...
          if (dropDiv) {
            ...
            imgElement.style.width="118%";
            imgElement.style.height="124%";
            imgElement.style.right="32px";
            imgElement.draggable = false;
            draggedItemId.value = null;
            dropDiv.innerHTML = "";
            dropDiv.appendChild(imgElement);
